<?php
// new-solid-start/server_examples/php_mysql_simulator/index.php
/**
 * PDO-backed PHP authentication demo with file-fallback.
 *
 * Endpoints:
 ...
 *
 * Behavior:
 * - If MySQL connection info is provided via environment variables (DB_HOST, DB_NAME, DB_USER, DB_PASS),
 *   this script uses PDO + prepared statements and stores users/sessions in MySQL.
 ...
 *
 * SQL migrations (returned by /admin/migration.sql):
 *
 * -- users table
 * CREATE TABLE users (
